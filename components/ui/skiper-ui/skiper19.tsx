...
const Skiper19 = () => {
  ...
  return (
    <section
  ref={ref}
  className="mx-auto flex min-h-[350vh] w-screen flex-col items-center overflow-hidden bg-[#FAFDEE] px-4 pb-[10vh] text-[#1F3A4B]"
>
  <div className="mt-38 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
    <h1 className="font-jakarta-sans relative z-10 text-7xl font-medium tracking-[-0.08em] lg:text-8xl">
      Turning Coffee <br /> into Code, <br />
      Ideas into Apps
    </h1>
  ...
  <div className="rounded-4xl font-jakarta-sans w-full translate-y-[100vh] bg-[#1F3A4B] pb-10 text-[#FAFDEE] lg:translate-y-[200vh]">
    ...
    <div className="mt-20 flex w-full flex-col items-start gap-5 px-4 font-medium lg:mt-0 lg:flex-row lg:justify-between">
      ...
      <div className="flex w-full items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
        <p className="w-fit text-sm">
          based in <br /> Bhopal, India
        </p>
        <p className="w-fit text-right ms-2 text-sm lg:text-left">
          available for <br /> remote & onsite
        </p>
      </div>
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
        <p className="w-fit text-sm">
          stack <br /> MERN + NEXT.js
        </p>
        <p className="w-fit text-right text-sm lg:text-left">
          extras <br /> tailwind, gsap, three.js
        </p>
      </div>
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
        <p className="w-fit text-sm">
          experience <br /> fullstack projects
        </p>
        <p className="w-fit text-right text-sm lg:text-left">
          open for <br /> collab & freelance
        </p>
      </div>
    </div>
  </div>
